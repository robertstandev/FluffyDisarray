...
[RequireComponent(typeof(ColliderUpdater), typeof(Movement), typeof(Jump))]
[RequireComponent(typeof(Stamina), typeof(CheckSurroundings))]

public class PlayerControllerAdvancedCollider : MonoBehaviour
{
    ...
    //     this.colliderUpdaterComponent = GetComponent<ColliderUpdater>();
    ...
    //     this.characterCollider = GetComponent<PolygonCollider2D>();
    // }
    ...
    // private void OnMove(InputAction.CallbackContext context) { this.movementComponent.move(this.mySpriteRenderer, context.ReadValue<float>()); }
    ...
    //     this.colliderUpdaterComponent.updateCollider(this.mySpriteRenderer, this.characterCollider);
    // }
